...
export const MONGO_DB_NAME: string = process.env.MONGO_DB_NAME || 'livecoinwatch';
...
export const DATA_POLLING_INTERVAL: number = parseInt(process.env.DATA_POLLING_INTERVAL || '10000', 10);